...
class GUI():
    def __init__(self,master):
        ...
        root.config(bg='#FF3521')
        root.resizable(False, False)

        self.label = Label(text=":AMAN PASSWORD TOOL:", anchor=N, fg='darkblue', bg='#FF5000', font='arial 20 bold underline')
        ...
        self.accept = Button(text="OK", bd=3, relief='solid', padx=1, pady=1, font='Helvetica 15 bold italic', fg='#458B00', bg='#FFFAF0', command=self.accept_fields)
        self.accept.grid(row=13, column=1)

        self.blank_label1 = Label(text="")
        self.blank_label1.grid(row=14, column=1)

        self.reset = Button(text="SUGEGST AGAIN", bd=3, relief='solid', padx=1, pady=1, font='Helvetica 15 bold italic', fg='#458B00', bg='#FFFAF0', command=self.reset_fields)
